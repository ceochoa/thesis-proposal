...
problem in the plane. They show that the computational complexity of
...
linear time. The algorithm identifies runs in the input order of
$\mathcal{S}$ in linear time. It computes the maximal points of
each runs in linear time and then merge the staircase of the sets of
maximal points two by two selecting the two smallest sets at each
time.
...
%% Maxima Deferrped Data Structure
