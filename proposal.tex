...
$\pi$ whose members have values $m_1, \dots, m_{\chi}$, we express the
time complexity of the algorithm \texttt{DLM Union} as within
...
two dimensions and online \textsc{Maxima} queries on sets of
...
\textbf{\begin{enumerate}
  ...
  \item Is there algorithms that take advantage of the input order for
    computing the maximal points in a more complex and efficient way
  ...
  \item Is there a MultiMaxima algorithm and a deferred data structure
...
\textbf{\begin{enumerate}
  ...
  \item Is there a MultiConvexHull algorithm and a deferred data structure
